...
export default function App(){
    return <>
        ...
        <footer className="flex justify-center items-center h-36 mt-20">
            <p className="text-white text-center text-balance">&copy; danielantcam.dev 2025. All rights reserved.</p>
        </footer>
    </>;
}